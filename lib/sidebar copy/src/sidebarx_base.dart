...
import 'widgets/sidebarx_cell.dart';
...
class _SidebarXState extends State<SidebarX> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        final selectedTheme = widget.controller.extended ? extendedT ?? widget.theme : widget.theme;
                      ...
                      return ExpansionTile(
                        ...
                        children: item.children
                            .map((e) => ListTile(
                                  leading: Icon(e.icon),
                                  title: Text(e.label!),
                                  onTap: () => _onItemSelected(e, index),
                                ))
                            .toList(),
                      );
                      // return SidebarXCellList(
                      //   item: item,
                      //   theme: t,
                      //   animationController: _animationController!,
  ...
  void _onFooterItemSelected(SidebarXItem item, int index) {
    item.onTap?.call();
    widget.controller.selectIndex(widget.items.length + widget.footerItems.length - index - 1);
  }
  ...
  Widget _buildToggleButton(
    ...
    return InkWell(
      ...
      child: Row(
        mainAxisAlignment:
            widget.controller.extended ? MainAxisAlignment.end : MainAxisAlignment.center,
        children: [
          Padding(
